		...
		<div class="program-info">
			<header>
				<h2 class="program-title"><a
						href="<?php echo get_the_permalink($program); ?>"><?php echo get_the_title($program); ?></a></h2>
				<?php the_terms($program, 'nvis_program_type'); ?>
			</header>
			<?php nvis_prog_get_template_part('archive-program/program-meta', compact('program')); ?>
		</div>
		<?php
