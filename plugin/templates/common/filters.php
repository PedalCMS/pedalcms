...
$defaults = [
    ...
    'icon_search'                => pdl_get_icon('magnifying-glass', ['size' => 20, 'class' => 'pdl-icon--md normal']),
    'icon_loading'               => pdl_get_icon('arrow-path', ['size' => 20, 'class' => 'pdl-icon--md loading']),
    'icon_reset'                 => pdl_get_icon('x-circle', ['size' => 20, 'class' => 'pdl-icon--md']),
    'filters'                    => ['keyword'],
];
