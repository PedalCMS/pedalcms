...
$field_group = [
    ...
    'fields'                => [
        ...
        [
            ...
            'sub_fields' => [
                [
                    'key'               => 'field_625436e5d0dbe',
                    'label'             => __('Default Post Featured Image', 'nvis-program-pages'),
                    'name'              => 'featured_image',
                    'type'              => 'image',
                    'instructions'      => __('The default featured image of individual posts. DOES NOT currently work, Person doesn\'t use the common/post-featured-image template.', 'nvis-program-pages'),
                    'required'          => 0,
                    'conditional_logic' => 0,
                    'wrapper'           => [
                        'width' => '',
